...
<main
  class="grid [place-items:start_center] min-h-screen py-[clamp(2rem,8vh,5rem)] px-4 bg-snow"
  data-ui-mode="place"
>
  <section
  ...
  >
    ...
    >
      {notFound ? 'Síðan fannst ekki' : 'Eitthvað fór úrskeiðis'}
    </h1>
    ...
    <Button
      href={resolve('/[lang=lang]', { lang: 'is' })}
      intent="committed"
