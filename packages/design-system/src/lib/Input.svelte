<script lang="ts">
  ...
  // The exact utility codification of .hv-field (primitives.css ~131-154): full width, the
  ...
  // The trailing focus-visible utilities share Button's known/deferred double ownership with
  // app.css's unlayered :focus-visible rule - identical values, settled in the retirement phase.
  const base =
